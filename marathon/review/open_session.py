...
def build_open_prompt(
    ...
    *,
    ...
    workflow = (
        ...
        "4. **Recommend a verdict.** Once the open-questions section "
        "is drained (or only deferred items remain), produce the "
        "concise verdict-forward bullets per Output format below. "
        "Then *stop and wait* for the verdict signal.\n"
    ...
    apply_section = (
        ...
        "After reject, a daemon iteration will run; expect another "
        "body-edit pass once it converges.\n\n"
